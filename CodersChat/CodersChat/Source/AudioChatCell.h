...
@interface AudioChatCell : IndividualChatCell

@property (weak, nonatomic) IBOutlet UIImageView *triangle;
@property (weak, nonatomic) IBOutlet UIImageView *imageView;
@property (weak, nonatomic) IBOutlet UIImageView *belowProgressView;
@property (weak, nonatomic) IBOutlet UIImageView *aboveProgressView;
@property (weak, nonatomic) IBOutlet UIImageView *progressViewMarker;
@property (weak, nonatomic) IBOutlet UIButton *playBtn;
@property (weak, nonatomic) IBOutlet UIImageView *userImageView;
@property (weak, nonatomic) IBOutlet UILabel *audioTimer;
