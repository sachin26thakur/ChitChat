...
- (void)resetAnimatorImageView{
    ...
    if(!_isLoaderPositionSet){
        ...
        if(self.indicatorImageView){
            ...
            self.indicatorImageView.frame = imageRect;//CGRectMake(5, 10, 36, 36);
        }
        if(self.indicatorRotationImageView){
            ...
            //imageRect = _indicator;
            self.indicatorRotationImageView.frame =imageRect;//CGRectMake(5, 10, 36, 36);; //
        }
    }
...
//        self.indicatorImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"loader_step1.png"]];
//        
...
//                                                     [UIImage imageNamed:@"loader_step1.png"],
//                                                     [UIImage imageNamed:@"loader_step2.png"],
//                                                     [UIImage imageNamed:@"loader_step3.png"],
//                                                     [UIImage imageNamed:@"loader_step4.png"], nil]];
        
        self.indicatorImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"loader_rotate_arrow.png"]];
        
        
        //circle on bg
//        UIImageView *imgViewBg = [[UIImageView alloc] initWithFrame:CGRectMake(111, 208
//                                                                               , 100, 100)];
        
//        UIImageView *imgViewBg = [[UIImageView alloc] initWithFrame:CGRectMake(imageRect.origin.x, imageRect.origin.y, 100, 100)];
//        [imgViewBg setBackgroundColor:[UIColor whiteColor]];
//        [imgViewBg.layer setCornerRadius:50.0f];
//        [self addSubview:imgViewBg];
        ...
        frm.origin.y=y;
        frm.size.height=40;
         frm.size.width=40;//self.indicatorImageView.frame.size;
        self.indicatorImageView.frame=frm;
        
//        UIImageView *imgViewBg = [[UIImageView alloc] initWithFrame:CGRectMake(self.indicatorImageView.frame.origin.x-13, self.indicatorImageView.frame.origin.y-14, 100, 100)];
//        [imgViewBg setBackgroundColor:[UIColor whiteColor]];
//        [imgViewBg.layer setCornerRadius:50.0f];
//        [self addSubview:imgViewBg];
//        
...
-(void)startRotating
{
    ...
    [self.indicatorImageView.layer addAnimation:fullRotation forKey:@"360"];
}
...
///////////Add changes by Shelesh..////////
	size.width=0;//200; changed JAT
    size.height=0;//133;chnaged JAT
	float radius = 1.0f;
